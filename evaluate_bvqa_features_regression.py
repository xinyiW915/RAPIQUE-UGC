...
def arg_parser():
    ...
    parser.add_argument('--feature_file', type=str,
                        default='/mnt/storage/home/um20242/scratch/RAPIQUE-UGC/feat_files/YOUTUBE_UGC_RAPIQUE_feats.mat',
                        help='Pre-computed feature matrix.')
    parser.add_argument('--mos_file', type=str,
                        default='/mnt/storage/home/um20242/scratch/RAPIQUE-UGC/mos_files/YOUTUBE_UGC_metadata.csv',
                        help='Dataset MOS scores.')
    parser.add_argument('--out_file', type=str,
                        default='/mnt/storage/home/um20242/scratch/RAPIQUE-UGC/result/YOUTUBE_UGC_RAPIQUE_SVR_corr.mat',
                        help='Output correlation results')
    parser.add_argument('--log_file', type=str,
                        default='/mnt/storage/home/um20242/scratch/RAPIQUE-UGC/logs/YOUTUBE_UGC_RAPIQUE_SVR.log',
                        help='Log files.')
...
def main(args):
    ...
    if args.dataset_name == 'LIVE_VQC':
        ...
        y = array[1:, 4]
    elif args.dataset_name == 'YOUTUBE_UGC_2160P':
        y = array[1:, 5]
    ...
    if args.color_only and args.dataset_name == 'YOUTUBE_UGC': # 'YOUTUBE_UGC'
        gray_indices = [3, 6, 10, 22, 23, 46, 51, 52, 68, 74, 77, 99, 103, 122, 136, 141, 158, 173, 368, 426, 467, 477,
                        506, 563, 594, \
                        639, 654, 657, 666, 670, 671, 681, 690, 697, 702, 703, 710, 726, 736, 764, 768, 777, 786, 796,
                        977, 990, 1012, \
