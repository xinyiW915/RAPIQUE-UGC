...
# csv_file = '/mnt/storage/home/um20242/scratch/RAPIQUE-UGC/mos_files/YOUTUBE_UGC_2160P_metadata.csv'
...
plt.show()
plt.title("2160P YT-UGC", fontsize=10)
